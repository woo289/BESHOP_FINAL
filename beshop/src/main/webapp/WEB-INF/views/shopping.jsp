...
<style>
   ...
   .nav_category_menu {
    ...
    /* 편성표 이미지 넣기 */
    .item1{background-image:url('img/event01(img).png'); }
    .item2{background-image:url('img/event02(img).png');}
    .item3{background-image:url('img/event03(img).png');}
    .item4{background-image:url('img/event04(img).png');}
    .item5{background-image:url('img/event05(img).png');}
    .item6{background-image:url('img/event06(img).png');}
...
<div class="container-fluid">
	<div class="container">
		...
		<div class="col-md-9">
		 <div class="col-md-0">
	                            <h4 style="margin-top:15px;"><a href="#">진행중인 이벤트</a></h4>
	                            <hr>
	                        </div>
                <div class="card">
                    <div class="card-body">
