			...
			if (SetTime == 0) {			// 시간이 종료 되었으면..
				...
				$.ajax({
					...
					success:function(data){
						alert("입찰자 : "+data.beuid+", 입찰가격 : "+data.price);
						if($("#beuid").val() == data.beuid){
							alert("입찰성공!! 마이페이지에서 구매를 진행해주세요");
   ...
   $("#sidenav02").css("right", "-1000px");
					...
					<div class="col-md-5">
						<div class="product-details">
							...
							<div>
							<input type="hidden" id="actionprice" name="price">
								...
								<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true">
						        	...
						        	<form class="f">
						                <div class="modal-content" style="width:700px;">
						                	...
						                	<div class="modal-header">현재 입찰가 :<span id="startprice"> ${de.p_price}</span> 원ㅣ무료배송 
